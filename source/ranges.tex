...
\indexlibrarymember{iterator_category}{iota_view::\exposid{iterator}}%
\indexlibrarymember{value_type}{iota_view::\exposid{iterator}}%
\indexlibrarymember{difference_type}{iota_view::\exposid{iterator}}%
\begin{codeblock}
namespace std::ranges {
...
\indexlibrarymember{iterator_concept}{iota_view::\exposid{iterator}}%
\pnum
...
(Here, forwarding an element \tcode{x} of type \tcode{U} within a tuple object
means calling \tcode{std::forward<U>(x)}.)
\end{itemdescr}
...
\indexlibrarymember{iterator_concept}{repeat_view::\exposid{iterator}}%
\indexlibrarymember{iterator_category}{repeat_view::\exposid{iterator}}%
\indexlibrarymember{value_type}{repeat_view::\exposid{iterator}}%
\indexlibrarymember{difference_type}{repeat_view::\exposid{iterator}}%
\begin{codeblock}
namespace std::ranges {
  template<@\libconcept{move_constructible}@ T, @\libconcept{semiregular}@ Bound = unreachable_sentinel_t>
    requires (is_object_v<T> && @\libconcept{same_as}@<T, remove_cv_t<T>> &&
...
\indexlibrarymember{iterator_concept}{basic_istream_view::\exposid{iterator}}%
\indexlibrarymember{difference_type}{basic_istream_view::\exposid{iterator}}%
\indexlibrarymember{value_type}{basic_istream_view::\exposid{iterator}}%
\begin{codeblock}
namespace std::ranges {
...
\rSec2[range.adaptor.tuple]{Range adaptor helpers}
...
\indexlibrarymember{value_type}{filter_view::\exposid{iterator}}%
\indexlibrarymember{difference_type}{filter_view::\exposid{iterator}}%
\begin{codeblock}
namespace std::ranges {
  template<@\libconcept{input_range}@ V, @\libconcept{indirect_unary_predicate}@<iterator_t<V>> Pred>
    requires @\libconcept{view}@<V> && is_object_v<Pred>
...
\indexlibrarymember{iterator_concept}{filter_view::\exposid{iterator}}%
\pnum
\tcode{\exposid{iterator}::iterator_concept} is defined as follows:
\begin{itemize}
...
\indexlibrarymember{iterator_category}{filter_view::\exposid{iterator}}%
\pnum
...
\indexlibrarymember{value_type}{transform_view::\exposid{iterator}}%
\indexlibrarymember{difference_type}{transform_view::\exposid{iterator}}%
\begin{codeblock}
namespace std::ranges {
  template<@\libconcept{input_range}@ V, @\libconcept{move_constructible}@ F>
    requires @\libconcept{view}@<V> && is_object_v<F> &&
...
\indexlibrarymember{iterator_concept}{transform_view::\exposid{iterator}}%
\pnum
\tcode{\exposid{iterator}::iterator_concept} is defined as follows:
\begin{itemize}
...
\indexlibrarymember{iterator_category}{transform_view::\exposid{iterator}}%
\pnum
The member \grammarterm{typedef-name} \tcode{iterator_category} is defined
...
\indexlibrarymember{value_type}{join_view::\exposid{iterator}}%
\begin{codeblock}
namespace std::ranges {
  template<@\libconcept{input_range}@ V>
    requires @\libconcept{view}@<V> && @\libconcept{input_range}@<range_reference_t<V>>
...
\indexlibrarymember{iterator_concept}{join_view::\exposid{iterator}}%
\pnum
\tcode{\exposid{iterator}::iterator_concept} is defined as follows:
\begin{itemize}
...
\indexlibrarymember{iterator_category}{join_view::\exposid{iterator}}%
\pnum
The member \grammarterm{typedef-name} \tcode{iterator_category} is defined
...
\indexlibrarymember{difference_type}{join_view::\exposid{iterator}}%
\pnum
...
\indexlibrarymember{iterator_concept}{join_with_view::\exposid{iterator}}%
\pnum
\tcode{\exposid{iterator}::iterator_concept} is defined as follows:
\begin{itemize}
\item
...
\indexlibrarymember{iterator_category}{join_with_view::\exposid{iterator}}%
\pnum
The member \grammarterm{typedef-name} \tcode{iterator_category} is defined
...
\indexlibrarymember{value_type}{join_with_view::\exposid{iterator}}%
\pnum
...
\indexlibrarymember{difference_type}{join_with_view::\exposid{iterator}}%
\pnum
...
\begin{itemdecl}
constexpr auto&& @\exposid{update-inner}@(const @\exposid{OuterIter}@& x);
\end{itemdecl}
...
\begin{itemdecl}
constexpr auto&& @\exposid{get-inner}@(const @\exposid{OuterIter}@& x);
\end{itemdecl}
...
\pnum
\effects
Equivalent to: \tcode{return x.\exposid{outer_it_} == y.\exposid{end_};}
\end{itemdescr}
...
\indexlibrarymember{iterator_concept}{lazy_split_view::\exposid{outer-iterator}}%
\indexlibrarymember{iterator_category}{lazy_split_view::\exposid{outer-iterator}}%
\indexlibrarymember{value_type}{lazy_split_view::\exposid{outer-iterator}}%
\indexlibrarymember{difference_type}{lazy_split_view::\exposid{outer-iterator}}%
\begin{codeblock}
namespace std::ranges {
  template<@\libconcept{input_range}@ V, @\libconcept{forward_range}@ Pattern>
    requires @\libconcept{view}@<V> && @\libconcept{view}@<Pattern> &&
...
\indexlibrarymember{iterator_concept}{lazy_split_view::\exposid{inner-iterator}}%
\indexlibrarymember{value_type}{lazy_split_view::\exposid{inner-iterator}}%
\indexlibrarymember{difference_type}{lazy_split_view::\exposid{inner-iterator}}%
\begin{codeblock}
namespace std::ranges {
  template<@\libconcept{input_range}@ V, @\libconcept{forward_range}@ Pattern>
    requires @\libconcept{view}@<V> && @\libconcept{view}@<Pattern> &&
...
\indexlibrarymember{iterator_category}{lazy_split_view::\exposid{inner-iterator}}%
\pnum
...
\indexlibrarymember{iterator_concept}{split_view::\exposid{iterator}}%
\indexlibrarymember{iterator_category}{split_view::\exposid{iterator}}%
\indexlibrarymember{value_type}{split_view::\exposid{iterator}}%
\indexlibrarymember{difference_type}{split_view::\exposid{iterator}}%
\begin{codeblock}
namespace std::ranges {
  template<@\libconcept{forward_range}@ V, @\libconcept{forward_range}@ Pattern>
    requires @\libconcept{view}@<V> && @\libconcept{view}@<Pattern> &&
...
\indexlibrarymember{value_type}{elements_view::\exposid{iterator}}%
\indexlibrarymember{difference_type}{elements_view::\exposid{iterator}}%
\begin{codeblock}
namespace std::ranges {
  template<@\libconcept{input_range}@ V, size_t N>
    requires @\libconcept{view}@<V> && @\exposconcept{has-tuple-element}@<range_value_t<V>, N> &&
...
\indexlibrarymember{iterator_concept}{elements_view::\exposid{iterator}}%
\pnum
...
\indexlibrarymember{iterator_category}{elements_view::\exposid{iterator}}%
\pnum
The member \grammarterm{typedef-name} \tcode{iterator_category} is defined
if and only if \exposid{Base} models \libconcept{forward_range}.
...
\indexlibrarymember{iterator_category}{zip_view::\exposid{iterator}}%
\indexlibrarymember{value_type}{zip_view::\exposid{iterator}}%
\indexlibrarymember{difference_type}{zip_view::\exposid{iterator}}%
\begin{codeblock}
namespace std::ranges {
...
\indexlibrarymember{iterator_concept}{zip_view::\exposid{iterator}}%
\pnum
\tcode{\exposid{iterator}::iterator_concept} is defined as follows:
\begin{itemize}
\item
...
\indexlibrarymember{iterator_concept}{zip_transform_view::\exposid{iterator}}%
\indexlibrarymember{value_type}{zip_transform_view::\exposid{iterator}}%
\indexlibrarymember{difference_type}{zip_transform_view::\exposid{iterator}}%
\begin{codeblock}
namespace std::ranges {
  template<@\libconcept{move_constructible}@ F, @\libconcept{input_range}@... Views>
    requires (@\libconcept{view}@<Views> && ...) && (sizeof...(Views) > 0) && is_object_v<F> &&
...
\indexlibrarymember{iterator_category}{zip_transform_view::\exposid{iterator}}%
\pnum
...
\indexlibrarymember{iterator_concept}{adjacent_transform_view::\exposid{iterator}}%
\indexlibrarymember{value_type}{adjacent_transform_view::\exposid{iterator}}%
\indexlibrarymember{difference_type}{adjacent_transform_view::\exposid{iterator}}%
\begin{codeblock}
namespace std::ranges {
  template<@\libconcept{forward_range}@ V, @\libconcept{move_constructible}@ F, size_t N>
    requires @\libconcept{view}@<V> && (N > 0) && is_object_v<F> &&
...
\indexlibrarymember{iterator_category}{adjacent_transform_view::\exposid{iterator}}%
\pnum
...
\indexlibrarymember{iterator_concept}{chunk_view::\exposid{outer-iterator}}%
\indexlibrarymember{difference_type}{chunk_view::\exposid{outer-iterator}}%
\begin{codeblock}
namespace std::ranges {
  template<@\libconcept{view}@ V>
    requires @\libconcept{input_range}@<V>
...
\indexlibrarymember{value_type}{chunk_view::\exposid{outer-iterator}}%
\begin{codeblock}
namespace std::ranges {
  template<@\libconcept{view}@ V>
    requires @\libconcept{input_range}@<V>
...
\indexlibrarymember{iterator_concept}{chunk_view::\exposid{inner-iterator}}%
\indexlibrarymember{difference_type}{chunk_view::\exposid{inner-iterator}}%
\indexlibrarymember{value_type}{chunk_view::\exposid{inner-iterator}}%
\begin{codeblock}
namespace std::ranges {
  template<@\libconcept{view}@ V>
    requires @\libconcept{input_range}@<V>
...
\indexlibrarymember{iterator_category}{chunk_view::\exposid{iterator}}%
\indexlibrarymember{value_type}{chunk_view::\exposid{iterator}}%
\indexlibrarymember{difference_type}{chunk_view::\exposid{iterator}}%
\begin{codeblock}
namespace std::ranges {
  template<@\libconcept{view}@ V>
    requires @\libconcept{forward_range}@<V>
...
\indexlibrarymember{iterator_concept}{chunk_view::\exposid{iterator}}%
\pnum
\tcode{\exposid{iterator}::iterator_concept} is defined as follows:
\begin{itemize}
\item
...
\indexlibrarymember{iterator_category}{slide_view::\exposid{iterator}}%
\indexlibrarymember{value_type}{slide_view::\exposid{iterator}}%
\indexlibrarymember{difference_type}{slide_view::\exposid{iterator}}%
\begin{codeblock}
namespace std::ranges {
  template<@\libconcept{forward_range}@ V>
    requires @\libconcept{view}@<V>
...
\indexlibrarymember{iterator_concept}{slide_view::\exposid{iterator}}%
\pnum
\tcode{\exposid{iterator}::iterator_concept} is defined as follows:
\begin{itemize}
\item
...
\indexlibrarymember{value_type}{chunk_by_view::\exposid{iterator}}%
\indexlibrarymember{difference_type}{chunk_by_view::\exposid{iterator}}%
\indexlibrarymember{iterator_category}{chunk_by_view::\exposid{iterator}}%
\begin{codeblock}
namespace std::ranges {
  template<@\libconcept{forward_range}@ V, @\libconcept{indirect_binary_predicate}@<iterator_t<V>, iterator_t<V>> Pred>
    requires @\libconcept{view}@<V> && is_object_v<Pred>
...
\indexlibrarymember{iterator_concept}{chunk_by_view::\exposid{iterator}}%
\pnum
\tcode{\exposid{iterator}::iterator_concept} is defined as follows:
\begin{itemize}
\item
...
\indexlibrarymember{difference_type}{stride_view::\exposid{iterator}}%
\indexlibrarymember{value_type}{stride_view::\exposid{iterator}}%
\begin{codeblock}
namespace std::ranges {
  template<@\libconcept{input_range}@ V>
    requires @\libconcept{view}@<V>
...
\indexlibrarymember{iterator_concept}{stride_view::\exposid{iterator}}%
\pnum
\tcode{\exposid{iterator}::iterator_concept} is defined as follows:
\begin{itemize}
\item
...
\indexlibrarymember{iterator_category}{stride_view::\exposid{iterator}}%
\pnum
The member \grammarterm{typedef-name} \tcode{iterator_category} is defined
if and only if \exposid{Base} models \libconcept{forward_range}.
In that case,
...
\indexlibrarymember{iterator_category}{cartesian_product_view::\exposid{iterator}}%
\indexlibrarymember{value_type}{cartesian_product_view::\exposid{iterator}}%
\indexlibrarymember{reference}{cartesian_product_view::\exposid{iterator}}%
\begin{codeblock}
namespace std::ranges {
  template<@\libconcept{input_range}@ First, @\libconcept{forward_range}@... Vs>
    requires (@\libconcept{view}@<First> && ... && @\libconcept{view}@<Vs>)
...
\indexlibrarymember{iterator_concept}{cartesian_product_view::\exposid{iterator}}%
\pnum
\tcode{\exposid{iterator}::iterator_concept} is defined as follows:
\begin{itemize}
\item
...
\indexlibrarymember{difference_type}{cartesian_product_view::\exposid{iterator}}%
\pnum
